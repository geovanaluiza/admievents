 ...
 */
declare const DEVTOOLS_INSPECTOR_DOCK_ID = "devframes-plugin-inspect";
declare const DEFAULT_CATEGORIES_ORDER: Record<string, number>;
//#endregion
export { DEFAULT_CATEGORIES_ORDER, DEFAULT_STATE_USER_SETTINGS, DEVTOOLS_CONNECTION_META_FILENAME, DEVTOOLS_DIRNAME, DEVTOOLS_DOCK_IMPORTS_FILENAME, DEVTOOLS_DOCK_IMPORTS_VIRTUAL_ID, DEVTOOLS_INSPECTOR_DOCK_ID, DEVTOOLS_MOUNT_PATH, DEVTOOLS_MOUNT_PATH_NO_TRAILING_SLASH, DEVTOOLS_RPC_DUMP_DIRNAME, DEVTOOLS_RPC_DUMP_MANIFEST_FILENAME, DEVTOOLS_VITEPLUS_GROUP_ID, DEVTOOLS_WS_PATH, DEVTOOLS_WS_ROUTE, type DevToolsDocksUserSettings, REMOTE_CONNECTION_KEY };