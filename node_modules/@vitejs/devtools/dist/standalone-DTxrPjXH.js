import { i as createDevToolsContext } from "./server-tX7Wj9Z1.js";
import { t as DevTools } from "./plugins-BeKV7vlV.js";
import process$1 from "node:process";
//#region src/node/standalone.ts
async function startStandaloneDevTools(options = {}) {
	const { cwd = process$1.cwd(), command = "build", mode = "production" } = options;
