...
`,t)}paste(e){this._core.paste(e)}refresh(e,t){this._verifyIntegers(e,t),this._core.refresh(e,t)}reset(){this._core.reset()}clearTextureAtlas(){this._core.clearTextureAtlas()}loadAddon(e){this._addonManager.loadAddon(this,e)}static get strings(){return{get promptLabel(){return de.get()},set promptLabel(e){de.set(e)},get tooMuchOutput(){return pe.get()},set tooMuchOutput(e){pe.set(e)}}}_verifyIntegers(...e){for(tc of e)if(tc===1/0||isNaN(tc)||tc%1!=0)throw Error(`This API only accepts integers`)}_verifyPositiveIntegers(...e){for(tc of e)if(tc&&(tc===1/0||isNaN(tc)||tc%1!=0||tc<0))throw Error(`This API only accepts positive integers`)}},rc=s({__name:`ViewBuiltinTerminalPanel`,props:{context:{},terminal:{}},setup(n){let r=n,o=f(),s;return e(async()=>{s=a(new nc({convertEol:!0,cols:80,screenReaderMode:!0}));let e=new v;if(s.loadAddon(e),s.open(o.value),e.fit(),i([()=>r.context.panel.store.width,()=>r.context.panel.store.height],()=>{g(()=>{e.fit()})}),re(window,`resize`,()=>{e.fit()}),g(()=>{e.fit()}),r.terminal.terminal=s,r.terminal.buffer==null){let{buffer:e}=await r.context.rpc.call(`devtoolskit:internal:terminals:read`,r.terminal.info.id);r.terminal.buffer=a(e)}for(let e of r.terminal.buffer)s.writeln(e)}),h(()=>{s.dispose(),r.terminal.terminal=null}),(e,n)=>(t(),c(`div`,{ref_key:`container`,ref:o,class:`h-full w-full of-auto bg-black`},null,512))}}),ic={class:`w-full h-full grid grid-rows-[max-content_1fr]`},ac={class:`border-base border-b rounded-t overflow-x-auto`},oc=[`onClick`],sc={class:`h-full w-full flex relative`},cc={key:1,class:`flex items-center justify-center h-full w-full text-center`},lc=s({__name:`ViewBuiltinTerminals`,props:{context:{}},setup(e){let n=oe(e.context),i=o(null);return te(n,()=>{i.value==null&&n.size>0&&(i.value=n.values().next().value)}),(a,o)=>(t(),c(`div`,ic,[u(`div`,ac,[(t(!0),c(l,null,r(m(n).values(),e=>(t(),c(`button`,{key:e.info.id,class:ee([`px3 py1.5 border-r border-base hover:bg-active text-sm flex items-center gap-1`,{"bg-active":i.value?.info.id===e.info.id}]),onClick:t=>i.value=e},[d(ne,{icon:e.info.icon||`ph:terminal-duotone`,class:`w-4 h-4`},null,8,[`icon`]),u(`span`,null,_(e.info.title),1)],10,oc))),128))]),u(`div`,sc,[i.value?(t(),p(rc,{key:i.value.info.id,context:e.context,terminal:i.value},null,8,[`context`,`terminal`])):(t(),c(`div`,cc,[...o[0]||=[u(`div`,null,`Select a terminal tab to start`,-1)]]))])]))}});export{lc as default};