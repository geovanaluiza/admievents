import{C as e,S as t,T as n,U as r,_ as i,en as a,g as o,h as s,m as c,p as l,ut as u}from"./vendor/json-editor-vue-mkw4apmc.js";import{z as d}from"./utils-hgmynvjd.js";import"./composables-ioamscf4.js";import{t as f}from"./ntip-m8x8y44j.js";import{t as p}from"./stacktrace-list-c5b46nul.js";var m=/(^|@)\S+:\d+/,h=/^\s*at .*(\S+:\d+|\(native\))/m,g=/^(eval@)?(\[native code\])?$/;function _(e,t){if(e.stacktrace!==void 0||e[`opera#sourceloc`]!==void 0)return w(e,t);if(e.stack&&e.stack.match(h))return b(e,t);if(e.stack)return S(e,t);if(t?.allowEmpty)return[];throw Error(`Cannot parse given Error object`)}function v(e){if(!e.includes(`:`))return[e,void 0,void 0];let t=/(.+?)(?::(\d+))?(?::(\d+))?$/.exec(e.replace(/[()]/g,``));return[t[1],t[2]||void 0,t[3]||void 0]}function y(e,t){return t&&t.slice!=null?Array.isArray(t.slice)?e.slice(t.slice[0],t.slice[1]):e.slice(0,t.slice):e}function b(e,t){return x(e.stack,t)}function x(e,t){return y(e.split(`
...
`).filter(e=>!!e.match(m)&&!e.match(/^Error created at/)),t).map(e=>{let t=e.split(`@`),n=v(t.pop()),r=t.shift()||``,i=r.replace(/<anonymous function(: (\w+))?>/,`$2`).replace(/\([^)]*\)/g,``)||void 0,a;return r.match(/\(([^)]*)\)/)&&(a=r.replace(/^[^(]+\(([^)]*)\)$/,`$1`)),{function:i,args:a===void 0||a===`[arguments not available]`?void 0:a.split(`,`),file:n[0],line:n[1]?+n[1]:void 0,col:n[2]?+n[2]:void 0,raw:e}})}function O(e){return e.map(e=>({functionName:e.function,args:e.args,fileName:e.file,lineNumber:e.line,columnNumber:e.col,source:e.raw}))}function k(e,t){return O(_(e,t))}var A={p6:``},j={key:0},M={"text-6xl":``},N={key:0,op75:``},P={my4:``,"text-xl":``,"text-red":``},F={key:1,"of-auto":``,rounded:``,"bg-active":``,p2:``},I=[`textContent`],L={key:1,op50:``},R=n({__name:`error`,setup(n){let m=/<.*?>/g,h=d(),g=l(()=>{let e=h.value?.nuxt?.payload?.error;return e&&(console.error(`[Nuxt DevTools] Error in payload:`),console.error(e),console.error({...e})),e}),_=l(()=>{if(!g.value?.stack)return[];try{return g.value.stack.startsWith(`<pre>`)?k({stack:g.value.stack.replace(m,``)}):k(g.value)}catch(e){return console.error(e),[]}});return(n,l)=>{let d=f,m=p;return r(),i(`div`,A,[g.value?(r(),i(`div`,j,[e(d,{n:`red`,icon:`i-carbon-warning-alt-filled`,mb5:``},{default:u(()=>[...l[0]||=[t(` Error occurred in this page `,-1)]]),_:1}),c(`div`,M,a(g.value.statusCode||`Client Error`),1),g.value.statusMessage?(r(),i(`div`,N,a(g.value.statusMessage),1)):o(``,!0),c(`div`,P,a(g.value.message||g.value.description||`Unknown error`),1),_.value.length||g.value.stack?(r(),i(`div`,F,[l[1]||=c(`div`,{px1:``,op50:``},` Stacktrace `,-1),_.value.length?(r(),s(m,{key:0,px2:``,stacktrace:_.value},null,8,[`stacktrace`])):(r(),i(`pre`,{key:1,textContent:a(g.value.stack)},null,8,I))])):o(``,!0)])):(r(),i(`div`,L,` No error `))])}}});export{R as default};