  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(event).schedule, (item) => {
        ...
        if (item.location) {
          _push(`<p class="print-desc" style="${ssrRenderStyle({ "font-style": "italic", "margin-top": "2pt" })}" data-v-29271506>\u{1F4CD} ${ssrInterpolate(item.location)}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</td></tr>`);
...
//# sourceMappingURL=_slug_-CawnvOqD.mjs.map
