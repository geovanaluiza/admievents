import { _ as _sfc_main$3, a as _sfc_main$4 } from "./SiteFooter-D9mtuOds.js";
import { defineComponent, computed, mergeProps, unref, useSSRContext, ref, watch, nextTick } from "vue";
...
const EVENTS = [
  {
    ...
    videoPlaceholder: {
      thumbnail: "https://i.ytimg.com/vi/UGxjeZtmvaE/maxresdefault.jpg",
      label: "What to expect at Discover NU",
      embedUrl: "https://www.youtube.com/embed/UGxjeZtmvaE"
    },
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-9a0bf40c>`);
      _push(ssrRenderComponent(_component_SiteHeader, { event: unref(event) }, null, _parent));
      _push(`<div class="no-print" aria-hidden="true" data-v-9a0bf40c></div><section class="event-hero" style="${ssrRenderStyle(`--event-accent: ${unref(colors).accent}; --event-light: ${unref(colors).light};`)}" data-v-9a0bf40c><div class="hero-bg-img" style="${ssrRenderStyle(`background-image: url('${unref(event).heroImage}')`)}" aria-hidden="true" data-v-9a0bf40c><div class="hero-bg-overlay" data-v-9a0bf40c></div></div><div class="container event-hero-inner" data-v-9a0bf40c><div class="event-hero-copy" data-v-9a0bf40c><div class="event-meta" data-v-9a0bf40c><span class="${ssrRenderClass(`badge ${unref(colors).tag}`)}" data-v-9a0bf40c>`);
      _push(ssrRenderComponent(_component_EventIcon, {
        name: unref(event).icon,
        size: 14
      }, null, _parent));
      _push(` ${ssrInterpolate(unref(event).name)}</span><span class="badge badge-dark" data-v-9a0bf40c>${ssrInterpolate(unref(selectedInst).timeStart)} – ${ssrInterpolate(unref(selectedInst).timeEnd)}</span></div><h1 class="event-title" data-v-9a0bf40c>${ssrInterpolate(unref(event).name)}</h1><p class="event-tagline" data-v-9a0bf40c>${ssrInterpolate(unref(event).tagline)}</p><div class="instance-picker" data-v-9a0bf40c><p class="instance-label" data-v-9a0bf40c><svg width="13" height="13" viewBox="0 0 24 24" fill="none" aria-hidden="true" data-v-9a0bf40c><rect x="3" y="4" width="18" height="18" rx="2" stroke="currentColor" stroke-width="2" data-v-9a0bf40c></rect><path d="M16 2v4M8 2v4M3 10h18" stroke="currentColor" stroke-width="2" stroke-linecap="round" data-v-9a0bf40c></path></svg> Pick your date </p><div class="instance-chips" data-v-9a0bf40c><!--[-->`);
      ssrRenderList(unref(event).instances, (inst) => {
        _push(`<button class="${ssrRenderClass([{ "is-active": inst.date === unref(selectedDate) }, "instance-chip"])}" data-v-9a0bf40c><span class="chip-weekday" data-v-9a0bf40c>${ssrInterpolate((/* @__PURE__ */ new Date(inst.date + "T00:00:00")).toLocaleDateString("en-US", { weekday: "short" }))}</span><span class="chip-date" data-v-9a0bf40c>${ssrInterpolate((/* @__PURE__ */ new Date(inst.date + "T00:00:00")).toLocaleDateString("en-US", { month: "short", day: "numeric" }))}</span><span class="chip-year" data-v-9a0bf40c>${ssrInterpolate((/* @__PURE__ */ new Date(inst.date + "T00:00:00")).getFullYear())}</span></button>`);
      });
      _push(`<!--]--></div></div><div class="event-ctas" data-v-9a0bf40c><a${ssrRenderAttr("href", unref(event).registrationUrl)} target="_blank" rel="noopener" class="btn btn-coral btn-lg" data-v-9a0bf40c><svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true" data-v-9a0bf40c><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-9a0bf40c></path></svg> Register for ${ssrInterpolate(unref(selectedInst).label)}</a><a${ssrRenderAttr("href", unref(event).swoopShopUrl)} target="_blank" rel="noopener" class="btn btn-outline btn-lg" style="${ssrRenderStyle({ "border-color": "rgba(0,104,187,.4)", "color": "#0068bb" })}" data-v-9a0bf40c>`);
      _push(ssrRenderComponent(_component_EventIcon, {
        name: "shopping-bag",
        size: 18
      }, null, _parent));
      _push(` Swoop Shop </a><button class="btn btn-outline btn-lg no-print" style="${ssrRenderStyle({ "border-color": "rgba(0,104,187,.4)", "color": "#0068bb" })}" data-v-9a0bf40c><svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true" data-v-9a0bf40c><polyline points="6 9 6 2 18 2 18 9" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-9a0bf40c></polyline><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-9a0bf40c></path><rect x="6" y="14" width="12" height="8" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-9a0bf40c></rect></svg> Print event info </button></div></div><div class="video-placeholder" data-v-9a0bf40c><div class="video-thumb" data-v-9a0bf40c>`);
      if (unref(videoPlaying) && unref(event).videoPlaceholder.embedUrl) {
        _push(`<iframe${ssrRenderAttr("src", `${unref(event).videoPlaceholder.embedUrl}?autoplay=1&rel=0`)}${ssrRenderAttr("title", unref(event).videoPlaceholder.label)} class="video-iframe" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen data-v-9a0bf40c></iframe>`);
      } else {
        _push(`<!--[--><img${ssrRenderAttr("src", unref(event).videoPlaceholder.thumbnail)}${ssrRenderAttr("alt", unref(event).videoPlaceholder.label)} loading="eager" data-v-9a0bf40c><div class="video-overlay" data-v-9a0bf40c><button class="play-ring"${ssrRenderAttr("aria-label", `Play: ${unref(event).videoPlaceholder.label}`)} data-v-9a0bf40c><svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" data-v-9a0bf40c><path d="M8 5v14l11-7z" data-v-9a0bf40c></path></svg></button></div><!--]-->`);
      }
      _push(`</div><p class="video-label" data-v-9a0bf40c>${ssrInterpolate(unref(event).videoPlaceholder.label)}</p>`);
      if (!unref(event).videoPlaceholder.embedUrl) {
        _push(`<span class="video-note badge badge-dark" data-v-9a0bf40c>Placeholder — video coming soon</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div></section><div class="container event-layout" data-v-9a0bf40c><div class="event-main" data-v-9a0bf40c><section class="event-section" id="about" data-v-9a0bf40c><h2 class="event-section-title" data-v-9a0bf40c>What to expect</h2><p class="event-body-text" data-v-9a0bf40c>${ssrInterpolate(unref(event).description)}</p></section><section class="event-section" id="schedule" data-v-9a0bf40c><div class="section-header-row" data-v-9a0bf40c><h2 class="event-section-title" data-v-9a0bf40c>Your day</h2><button class="btn btn-outline btn-sm no-print" data-v-9a0bf40c><svg width="14" height="14" viewBox="0 0 24 24" fill="none" aria-hidden="true" data-v-9a0bf40c><polyline points="6 9 6 2 18 2 18 9" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-9a0bf40c></polyline><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-9a0bf40c></path><rect x="6" y="14" width="12" height="8" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-9a0bf40c></rect></svg> Print schedule </button></div><div class="schedule-timeline" data-v-9a0bf40c><!--[-->`);
      ssrRenderList(unref(event).schedule, (item, i) => {
        _push(`<div class="timeline-item" data-v-9a0bf40c><div class="tl-time" data-v-9a0bf40c>${ssrInterpolate(item.time)}</div><div class="tl-dot" style="${ssrRenderStyle(`background: ${unref(colors).accent}`)}" aria-hidden="true" data-v-9a0bf40c></div><div class="tl-content" data-v-9a0bf40c><div class="tl-header" data-v-9a0bf40c><span class="tl-icon" aria-hidden="true" data-v-9a0bf40c>`);
        _push(ssrRenderComponent(_component_EventIcon, {
          name: item.icon,
          size: 18
        }, null, _parent));
        _push(`</span><h3 class="tl-title" data-v-9a0bf40c>${ssrInterpolate(item.title)}</h3></div>`);
        if (item.description) {
          _push(`<p class="tl-desc" data-v-9a0bf40c>${ssrInterpolate(item.description)}</p>`);
        } else {
          _push(`<!---->`);
        }
        if (item.location) {
          _push(`<p class="tl-location" data-v-9a0bf40c><svg width="11" height="11" viewBox="0 0 24 24" fill="none" aria-hidden="true" data-v-9a0bf40c><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" stroke="currentColor" stroke-width="2" data-v-9a0bf40c></path><circle cx="12" cy="10" r="3" stroke="currentColor" stroke-width="2" data-v-9a0bf40c></circle></svg> ${ssrInterpolate(item.location)}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div>`);
      });
      _push(`<!--]--></div></section><section class="event-section" id="bring" data-v-9a0bf40c><h2 class="event-section-title" data-v-9a0bf40c>What to bring</h2><div class="bring-grid" data-v-9a0bf40c><!--[-->`);
      ssrRenderList(unref(event).bringItems, (item, i) => {
        _push(`<div class="bring-item" data-v-9a0bf40c><span class="bring-icon" aria-hidden="true" data-v-9a0bf40c>`);
        _push(ssrRenderComponent(_component_EventIcon, {
          name: item.icon,
          size: 20
        }, null, _parent));
        _push(`</span><span class="bring-text" data-v-9a0bf40c>${ssrInterpolate(item.text)}</span></div>`);
      });
      _push(`<!--]--></div><div class="dress-code-box card-ghost" data-v-9a0bf40c><div class="dress-icon" aria-hidden="true" data-v-9a0bf40c><svg width="22" height="22" viewBox="0 0 24 24" fill="none" data-v-9a0bf40c><path d="M20.38 3.46L16 2a4 4 0 01-8 0L3.62 3.46a2 2 0 00-1.34 2.23l.58 3.47a1 1 0 00.99.84H6v10c0 1.1.9 2 2 2h8a2 2 0 002-2V10h2.15a1 1 0 00.99-.84l.58-3.47a2 2 0 00-1.34-2.23z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-9a0bf40c></path></svg></div><div data-v-9a0bf40c><p class="dress-label" data-v-9a0bf40c>Dress code</p><p class="dress-code-val" data-v-9a0bf40c>${ssrInterpolate(unref(event).dressCode)}</p><p class="dress-tip" data-v-9a0bf40c>${ssrInterpolate(unref(event).dressCodeTip)}</p></div></div></section><section class="event-section parents-section" id="parents" data-v-9a0bf40c><div class="parents-header" data-v-9a0bf40c><span class="parents-emoji" aria-hidden="true" data-v-9a0bf40c>`);
      _push(ssrRenderComponent(_component_EventIcon, {
        name: "users",
        size: 34
      }, null, _parent));
      _push(`</span><div data-v-9a0bf40c><h2 class="event-section-title" data-v-9a0bf40c>${ssrInterpolate(unref(event).parentsTitle)}</h2><p class="event-body-text" data-v-9a0bf40c>${ssrInterpolate(unref(event).parentsIntro)}</p></div></div><div class="parents-grid" data-v-9a0bf40c><!--[-->`);
      ssrRenderList(unref(event).parentsItems, (item, i) => {
        _push(`<div class="parent-card card-ghost" data-v-9a0bf40c><span class="parent-icon" aria-hidden="true" data-v-9a0bf40c>`);
        _push(ssrRenderComponent(_component_EventIcon, {
          name: item.icon,
          size: 22
        }, null, _parent));
        _push(`</span><h3 class="parent-title" data-v-9a0bf40c>${ssrInterpolate(item.title)}</h3><p class="parent-body" data-v-9a0bf40c>${ssrInterpolate(item.body)}</p></div>`);
      });
      _push(`<!--]--></div></section>`);
      if (unref(event).financialAid) {
        _push(`<section class="event-section faid-section" id="aid" data-v-9a0bf40c><div class="faid-box card-ghost" data-v-9a0bf40c><div class="faid-icon" aria-hidden="true" data-v-9a0bf40c><svg width="24" height="24" viewBox="0 0 24 24" fill="none" data-v-9a0bf40c><path d="M12 2v20M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6" stroke="var(--accent-gold)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-9a0bf40c></path></svg></div><div class="faid-body" data-v-9a0bf40c><h3 class="faid-headline" data-v-9a0bf40c>${ssrInterpolate(unref(event).financialAid.headline)}</h3><p class="faid-text" data-v-9a0bf40c>${ssrInterpolate(unref(event).financialAid.body)}</p></div><a${ssrRenderAttr("href", unref(event).financialAid.ctaUrl)} target="_blank" rel="noopener" class="btn btn-gold btn-sm" data-v-9a0bf40c>${ssrInterpolate(unref(event).financialAid.ctaLabel)}</a></div></section>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<section class="event-section" id="faq" data-v-9a0bf40c><h2 class="event-section-title" data-v-9a0bf40c>Questions &amp; answers</h2><div class="faq-filters no-print" role="tablist" aria-label="Filter FAQ by topic" data-v-9a0bf40c><!--[-->`);
      ssrRenderList(faqCategories, (cat) => {
        _push(`<button class="${ssrRenderClass([{ "is-active": unref(activeFaqCat) === cat.key }, "faq-tab"])}" role="tab"${ssrRenderAttr("aria-selected", unref(activeFaqCat) === cat.key)} data-v-9a0bf40c>${ssrInterpolate(cat.label)}</button>`);
      });
      _push(`<!--]--></div><div class="faq-list" data-v-9a0bf40c><!--[-->`);
      ssrRenderList(unref(filteredFaqs), (faq) => {
        _push(`<div class="faq-item" data-v-9a0bf40c><button class="faq-q"${ssrRenderAttr("aria-expanded", unref(openFaq) === faq.q)} data-v-9a0bf40c><span data-v-9a0bf40c>${ssrInterpolate(faq.q)}</span><svg class="${ssrRenderClass([{ "is-open": unref(openFaq) === faq.q }, "faq-chevron"])}" width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden="true" data-v-9a0bf40c><polyline points="6 9 12 15 18 9" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-9a0bf40c></polyline></svg></button>`);
        if (unref(openFaq) === faq.q) {
          _push(`<div class="faq-a" data-v-9a0bf40c><p data-v-9a0bf40c>${ssrInterpolate(faq.a)}</p></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      });
      _push(`<!--]--></div></section></div><aside class="event-sidebar" data-v-9a0bf40c><div class="reg-card card" style="${ssrRenderStyle(`--card-accent: ${unref(colors).accent}`)}" data-v-9a0bf40c><div class="reg-card-header" style="${ssrRenderStyle(`background: ${unref(colors).light}`)}" data-v-9a0bf40c><p class="reg-date-display" data-v-9a0bf40c><span class="reg-weekday" data-v-9a0bf40c>${ssrInterpolate((/* @__PURE__ */ new Date(unref(selectedDate) + "T00:00:00")).toLocaleDateString("en-US", { weekday: "long" }))}</span><span class="reg-full" data-v-9a0bf40c>${ssrInterpolate((/* @__PURE__ */ new Date(unref(selectedDate) + "T00:00:00")).toLocaleDateString("en-US", { month: "long", day: "numeric", year: "numeric" }))}</span></p><p class="reg-time" data-v-9a0bf40c><svg width="13" height="13" viewBox="0 0 24 24" fill="none" aria-hidden="true" data-v-9a0bf40c><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2" data-v-9a0bf40c></circle><polyline points="12 6 12 12 16 14" stroke="currentColor" stroke-width="2" stroke-linecap="round" data-v-9a0bf40c></polyline></svg> ${ssrInterpolate(unref(selectedInst).timeStart)} – ${ssrInterpolate(unref(selectedInst).timeEnd)}</p></div><div class="reg-card-body" data-v-9a0bf40c><a${ssrRenderAttr("href", unref(event).registrationUrl)} target="_blank" rel="noopener" class="btn btn-coral btn-full btn-lg" data-v-9a0bf40c> Register now — it&#39;s free </a><a${ssrRenderAttr("href", unref(event).swoopShopUrl)} target="_blank" rel="noopener" class="btn btn-outline btn-full btn-sm" data-v-9a0bf40c>`);
      _push(ssrRenderComponent(_component_EventIcon, {
        name: "shopping-bag",
        size: 16
      }, null, _parent));
      _push(` Swoop Shop </a><p class="reg-note" data-v-9a0bf40c>No commitment required to register.</p></div></div><div class="badge-generator card" data-v-9a0bf40c><h3 class="badge-gen-title" data-v-9a0bf40c><svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden="true" data-v-9a0bf40c><rect x="2" y="7" width="20" height="14" rx="2" stroke="currentColor" stroke-width="2" data-v-9a0bf40c></rect><path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2" stroke="currentColor" stroke-width="2" data-v-9a0bf40c></path></svg> Make your name tag </h3><p class="badge-gen-sub" data-v-9a0bf40c>Your name as it will appear on your event badge:</p><div class="field" data-v-9a0bf40c><label for="badgeName" data-v-9a0bf40c>Your name</label><input id="badgeName"${ssrRenderAttr("value", unref(badgeName))} type="text" placeholder="e.g. Maya Thompson" maxlength="40" data-v-9a0bf40c></div>`);
      if (unref(badgeName)) {
        _push(`<div class="badge-preview" style="${ssrRenderStyle(`border-color: ${unref(colors).accent}; background: ${unref(colors).light}`)}" data-v-9a0bf40c><p class="badge-preview-label" data-v-9a0bf40c>Preview</p><p class="badge-preview-name" data-v-9a0bf40c>${ssrInterpolate(unref(badgeName))}</p><p class="badge-preview-event" data-v-9a0bf40c>${ssrInterpolate(unref(event).name)} · ${ssrInterpolate(unref(selectedInst).label)}</p></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="contact-card card-ghost" data-v-9a0bf40c><h3 class="contact-title" data-v-9a0bf40c>Questions?</h3><p class="contact-body" data-v-9a0bf40c>Our admissions team replies within one business day.</p><a href="mailto:admissions@northwestu.edu" class="contact-link" data-v-9a0bf40c><svg width="14" height="14" viewBox="0 0 24 24" fill="none" aria-hidden="true" data-v-9a0bf40c><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" stroke="currentColor" stroke-width="2" data-v-9a0bf40c></path><polyline points="22,6 12,13 2,6" stroke="currentColor" stroke-width="2" stroke-linecap="round" data-v-9a0bf40c></polyline></svg> admissions@northwestu.edu </a></div></aside></div><div class="print-only-page" data-v-9a0bf40c><header class="print-header" data-v-9a0bf40c><svg class="print-shield" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" data-v-9a0bf40c><path d="M32 4L8 14v18c0 14 24 22 24 22s24-8 24-22V14L32 4z" fill="#0068bb" stroke="#fbd945" stroke-width="2" data-v-9a0bf40c></path><text x="32" y="38" text-anchor="middle" font-size="14" font-weight="900" fill="#fbd945" font-family="system-ui" data-v-9a0bf40c>NU</text></svg><p class="print-event-type" data-v-9a0bf40c>Northwest University · Admissions Event</p><h1 class="print-event-name" data-v-9a0bf40c>${ssrInterpolate(unref(event).name)}</h1><p class="print-event-tagline" data-v-9a0bf40c>${ssrInterpolate(unref(event).tagline)}</p><div class="print-event-meta" data-v-9a0bf40c><div class="print-meta-item" data-v-9a0bf40c><div class="print-meta-icon" data-v-9a0bf40c><svg viewBox="0 0 24 24" fill="none" data-v-9a0bf40c><rect x="3" y="4" width="18" height="18" rx="2" stroke="white" stroke-width="2" data-v-9a0bf40c></rect><path d="M16 2v4M8 2v4M3 10h18" stroke="white" stroke-width="2" stroke-linecap="round" data-v-9a0bf40c></path></svg></div><div data-v-9a0bf40c><p class="print-meta-label" data-v-9a0bf40c>Date</p><p class="print-meta-value" data-v-9a0bf40c>${ssrInterpolate(unref(selectedInst).label)}</p></div></div><div class="print-meta-item" data-v-9a0bf40c><div class="print-meta-icon" data-v-9a0bf40c><svg viewBox="0 0 24 24" fill="none" data-v-9a0bf40c><circle cx="12" cy="12" r="10" stroke="white" stroke-width="2" data-v-9a0bf40c></circle><polyline points="12 6 12 12 16 14" stroke="white" stroke-width="2" stroke-linecap="round" data-v-9a0bf40c></polyline></svg></div><div data-v-9a0bf40c><p class="print-meta-label" data-v-9a0bf40c>Time</p><p class="print-meta-value" data-v-9a0bf40c>${ssrInterpolate(unref(selectedInst).timeStart)} – ${ssrInterpolate(unref(selectedInst).timeEnd)}</p></div></div><div class="print-meta-item" data-v-9a0bf40c><div class="print-meta-icon" data-v-9a0bf40c><svg viewBox="0 0 24 24" fill="none" data-v-9a0bf40c><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" stroke="white" stroke-width="2" data-v-9a0bf40c></path><circle cx="12" cy="10" r="3" stroke="white" stroke-width="2" data-v-9a0bf40c></circle></svg></div><div data-v-9a0bf40c><p class="print-meta-label" data-v-9a0bf40c>Location</p><p class="print-meta-value" data-v-9a0bf40c>Northwest University, Kirkland WA</p></div></div></div></header><div class="print-body" data-v-9a0bf40c><div class="print-reg-box" data-v-9a0bf40c><div class="print-qr-placeholder" aria-hidden="true" data-v-9a0bf40c><div class="print-qr-placeholder-inner" data-v-9a0bf40c></div></div><div data-v-9a0bf40c><p class="print-reg-label" data-v-9a0bf40c>Register at</p><p class="print-reg-url" data-v-9a0bf40c>${ssrInterpolate(unref(event).registrationUrl)}</p></div></div><section data-v-9a0bf40c><h2 class="print-section-title" data-v-9a0bf40c>Schedule</h2><table class="print-schedule" data-v-9a0bf40c><thead data-v-9a0bf40c><tr data-v-9a0bf40c><th data-v-9a0bf40c>Time</th><th data-v-9a0bf40c>Activity</th><th data-v-9a0bf40c>Details</th></tr></thead><tbody data-v-9a0bf40c><!--[-->`);
      ssrRenderList(unref(event).schedule, (item) => {
        _push(`<tr data-v-9a0bf40c><td class="print-time" data-v-9a0bf40c>${ssrInterpolate(item.time)}</td><td data-v-9a0bf40c><p class="print-title" data-v-9a0bf40c>${ssrInterpolate(item.title)}</p>`);
        if (item.track && item.track !== "all") {
          _push(`<span class="${ssrRenderClass(`print-track print-track-${item.track}`)}" data-v-9a0bf40c>${ssrInterpolate(item.track)}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</td><td data-v-9a0bf40c><p class="print-desc" data-v-9a0bf40c>${ssrInterpolate(item.description)}</p>`);
        if (item.location) {
          _push(`<p class="print-desc" style="${ssrRenderStyle({ "font-style": "italic", "margin-top": "2pt" })}" data-v-9a0bf40c>${ssrInterpolate(item.location)}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</td></tr>`);
      });
      _push(`<!--]--></tbody></table></section><section data-v-9a0bf40c><h2 class="print-section-title" data-v-9a0bf40c>What to bring</h2><div class="print-bring" data-v-9a0bf40c><!--[-->`);
      ssrRenderList(unref(event).bringItems, (item) => {
        _push(`<div class="print-bring-item" data-v-9a0bf40c><span class="print-bring-icon" aria-hidden="true" data-v-9a0bf40c>`);
        _push(ssrRenderComponent(_component_EventIcon, {
          name: item.icon,
          size: 12
        }, null, _parent));
        _push(`</span><span class="print-bring-text" data-v-9a0bf40c>${ssrInterpolate(item.text)}</span></div>`);
      });
      _push(`<!--]--></div></section><section data-v-9a0bf40c><h2 class="print-section-title" data-v-9a0bf40c>Dress code</h2><div class="print-dress" data-v-9a0bf40c><div class="print-dress-icon" aria-hidden="true" data-v-9a0bf40c><svg width="18" height="18" viewBox="0 0 24 24" fill="none" data-v-9a0bf40c><path d="M20.38 3.46L16 2a4 4 0 01-8 0L3.62 3.46a2 2 0 00-1.34 2.23l.58 3.47a1 1 0 00.99.84H6v10c0 1.1.9 2 2 2h8a2 2 0 002-2V10h2.15a1 1 0 00.99-.84l.58-3.47a2 2 0 00-1.34-2.23z" stroke="#0068bb" stroke-width="1.5" data-v-9a0bf40c></path></svg></div><div data-v-9a0bf40c><p class="print-dress-label" data-v-9a0bf40c>Dress code</p><p class="print-dress-value" data-v-9a0bf40c>${ssrInterpolate(unref(event).dressCode)}</p><p class="print-dress-tip" data-v-9a0bf40c>${ssrInterpolate(unref(event).dressCodeTip)}</p></div></div></section><footer class="print-footer" data-v-9a0bf40c><span data-v-9a0bf40c>Northwest University · Kirkland, WA · northwestu.edu</span><span data-v-9a0bf40c>Questions? <a${ssrRenderAttr("href", `mailto:${"admissions@northwestu.edu"}`)} data-v-9a0bf40c>admissions@northwestu.edu</a> · (425) 555-1234</span></footer></div></div>`);
...
const _slug_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9a0bf40c"]]);
export {
  _slug_ as default
};
//# sourceMappingURL=_slug_-B2nfdpdb.js.map
